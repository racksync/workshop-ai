...
- **หน้าตาที่ใช้งานง่าย**: อินเตอร์เฟซแบบแชทที่คล้ายกับ ChatGPT ใช้งานได้ทันที
...
- **รันโมเดลแบบ Local**: รันโมเดล LLM บนเครื่องของคุณเอง ทำให้ข้อมูลไม่รั่วไหลไปยังบริการคลาวด์ภายนอก
